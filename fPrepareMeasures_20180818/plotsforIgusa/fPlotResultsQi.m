...
if flag_use_composites
    ...
    load fPrepareMeasuresQiResults_no_composites % load results without composites
end
load ttl0
flag.report = 0;                                 % 1-format for the report, 0-for analysis
...
for i=1:nSubdomains                              % for each measure
    ...
    if nResults>2                                % if at least two results
        ...
        ax.Position(2) = ax.Position(2) - ax.Position(4) * 0.2;
        %         grid on
