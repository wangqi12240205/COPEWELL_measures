...
%         if flag.Direc0
%         title(['Published directions, \alpha = ' num2str(round(CAlast,2))],'Fontsize',20) % title
%         else
%         title(['Directions maximizing alpha, \alpha = ' num2str(round(CAlast,2))],'Fontsize',20) % title
%         end
%         set(gca,'xtick',[1:num]),set(gca,'xticklabel',Letters(1:num),'Fontsize',20);% xtick
%         set(gca,'ytick',[1:num]),set(gca,'yticklabel',Letters(1:num),'Fontsize',20);% ytick
%         
...
%         
%         set(AX,'YTick',[0 0.5 1],'Fontsize',15);                                            % set xtick
%         set(AX,'XTick',[0 0.5 1],'Fontsize',15);                                            % set ytick
%         
%         
...
%                         co = 'black';
%                     end
%                     text(AX(j,mm),0,0,num2str(round(corre(j,mm),2)),'color',co,'Fontsize',18)
%                 end
%             end
%         end
%         
...
%         if flag.Direc0
%              saveas(gca, ['figure_corr_original/' u_DS0(j0,:) '.fig']);
%         else
%             
%         saveas(gca, ['figure_corr_max_current/' u_DS0(j0,:) '.fig']);
%         end
